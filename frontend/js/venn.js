(function (global, factory) {
    ...
    function greedyLayout(areas, params) {
    	//console.log("greedyLayout fct line 822");
    	//console.log(areas);
    	//console.log(params);
        ...
        for (var i = 0; i < areas.length; ++i) {
            var area = areas[i];
            //console.log("greedyLayout line 830");
            //console.log(area.sets.length);
            if (area.sets.length == 1) {
                set = area.sets[0];
        ...
        //console.log("Venn : greedyLayout, line 839");
        //console.log(setOverlaps);
        areas = areas.filter(function(a) { return a.sets.length == 2; });
        //console.log("Venn : greedyLayout, line 842");
        //console.log(areas);
        ...
        for (i = 0; i < areas.length; ++i) {
            ...
            //console.log("greedyLayout, line 848");
			//console.log(left);
			//console.log(right);
        ...
        //console.log("Venn : greedyLayout, line 858");
        //console.log(setOverlaps);
        ...
        //console.log("Venn : greedyLayout, line 874");
        //console.log(setOverlaps);
