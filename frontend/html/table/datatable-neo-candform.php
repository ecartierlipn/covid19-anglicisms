...
<script type="text/javascript" charset="utf-8" src="js/table.neologismes2.js"/>
<style>
[id*=range-] { width: 100%; }
[id*=dc-]{ width: 100%; }
...
[id*=dc-core] g.row text {
	...
	<div class="side-body">
    	<div class="page-title">
        	<span class="title">Gestionnaire des néologismes (Logoscope & Néoveille)</span>
		</div>
        ...
        <div class="description">
		  <!-- filtres colonnes -->
			<div id="info">
				<table width="99%"><tr><td colspan="6"><h5>Filtres</h5></td></tr>
					<tr><td id="example_neo"></td><td id="example_type"></td><td id="example_comment"></td><td id="example_freqBNF"></td><td id="example_freqNEO"></td><td id="example_date"></td></tr>
