...
[id*=dc-neo-chart] g.row text {
	...
	<!--<div class="side-body">-->
		...
		Les  résultats sont présentés sous forme d'une liste  (limitée à 50 occurrences dans la partie publique) et de graphes interactifs permettant 
		de refiltrer les résultats.  Les corpus sont présentés dans le menu "synthèse" à gauche.   
		Pour obtenir un accès complet au corpus, envoyez un email à admin@neoveille.org pour obtenir un identifiant 
		et un mot de passe.
        </div>
