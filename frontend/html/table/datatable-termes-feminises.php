...
<script type="text/javascript" charset="utf-8" src="./js/table.termes-feminises.js"/>
<style>
[id*=range-] { width: 100%; }
[id*=dc-]{ width: 100%; }
...
[id*=dc-core] g.row text {
	...
	<div class="side-body">
    	<div class="page-title">
        	<span class="title">Gestionnaire des lexies féminisés</span>
		</div>
		<div class="alert alert-info alert-dismissible" role="alert">
        	<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	<strong>Information  :</strong> cette base contient l'ensemble des néologismes fournis par les plateformes Logoscope et Néoveille dans le projet Néonaute. <br/>Les données peuvent être éditées de trois manières : en cliquant directement dans les cellules "Partie du discours" ou "Source"; en sélectionnant le bouton édition à gauche de chaque ligne; en sélectionnant une ligne et en cliquant sur le bouton "Modifier".<br/>
		...
		<a type="button" class="btn btn-success" id="fem_synthesis" href="./php/db_access.php?action=fem_synthesis">Téléchargement synthèse</a>
<!--		<a type="button" class="btn btn-success" id="fem_synthesis2" href="./php/db_access.php?action=fem_synthesis2">Téléchargement synthèse (résultats recherche)</a>-->

        <div class="description">
		  <!-- filtres colonnes -->
			<div id="info">
				<table width="99%"><tr><td colspan="5"><h5>Filtres</h5></td></tr>
					<tr><td id="example_neo"></td><td id="example_comment"></td><td id="example_freqBNF"></td><td id="example_freqNEO"></td><td id="example_date"></td></tr>
                	...
                	<div class="card">
                    	<div class="card-body">
                            <table class="datatable table" cellspacing="0" id="example">
								<thead>
									<tr>
										<th>Forme masculine</th>
										<!--<th>Formes féminines</th>-->
										<th>Commentaire</th>
										<th>Fréquence globale (BNF)</th>
										<th>Fréquence globale (Néoveille)</th>
