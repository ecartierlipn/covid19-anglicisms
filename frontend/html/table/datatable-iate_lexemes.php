...
<script type="text/javascript" charset="utf-8" src="js/table.iate_lexemes.js"></script>
...
<div class="side-body">
		...
		<ul class="nav nav-tabs" role="tablist">
    		<li role="gestionnaire" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Lexemes Manager</a></li>
    		<li role="presentation"><a href="#stats" aria-controls="stats" role="tab" data-toggle="tab">Lexeme Statistics (to be done)</a></li>
  		</ul>
		<!-- tab panes -->
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane fade in active" id="home">	
    			<div class="page-title">
        			<span class="title">IATE Lexemes Manager</span>
				</div>
                	...
                	<div class="card"  style="width:95vw">
                    	<div class="card-body">
                            <table class="datatable table display" cellspacing="0" id="exampleNeo"  style="width:95vw;">
								<thead>
									<tr><td colspan="15"><b>Filters</b></td></tr>
									<tr>
										<th>Lexeme</th>
										<th>Concept id</th>
										<th>Language</th>
