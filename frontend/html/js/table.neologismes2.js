...
//		ajax: "php/neologismes2.php?lang="+languageW,
		ajax : {url:"php/neologismes2.php?lang="+languageW,type:"POST",dataType:"json"},
		table: "#example",
		lang:languageW,
		display: "envelope",
		fields: [ {
...
$(document).ready( function () {
				$('#example').dataTable().columnFilter({
					aoColumns: [ 
            			...
            			{sSelector: "#example_freqBNF", type: "number" },
            			{sSelector: "#example_freqNEO", type: "number" },
...
/*			{
			...
			{ data: "origine", className: 'editable' },
			{ data: "commentaire" , className: 'editable'},
			{ data: "freq_BNF" },
			{ data: "freq_neoveille" }, 
			{ data: "last_update" }, 
			// contexts from neoveille
			/*{
...
function get_neo_info_mysqldata(lang,neo,callback) 
{
    	...
    	console.log(neo);
		d3.json("./php/db_access.php?action=neoveille&id="+neo.forme, function(error, data) {
        	console.log(data);
        	console.log(error);
        	count = data.length;
        	console.log(count);
