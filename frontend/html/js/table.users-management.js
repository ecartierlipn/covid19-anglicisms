...
*/			{
			...
			{
				"label": "Droits génériques",
				"name": "users.user_rights",
				"type": "select",
				"options": [0,1,2]
			}
		]
...
var table = $('#usersT').DataTable( {
		...
		columns: [		
			...
			{ data: "users.user_rights",   className: 'editable' },
			{ data: "def_language.name",  className: 'editable' },
			{
