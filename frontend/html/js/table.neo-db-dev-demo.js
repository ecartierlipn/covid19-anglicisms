...
{
		var langues = {'Es':"es_neo.tsv",'It':"it_neo.tsv",'Fr':"fr_neo.tsv", 'Pl':"pl_neo.tsv", 'Br':'br_neo.tsv', 'Ch':'ch_neo.tsv', 'Ru':'ru_neo.tsv', 'Cz':'cz_neo.tsv', 'Gr':'gr_neo.tsv'};
...
//    $("#neoResults"+lang).css( "display", "visible !important");
	$("#neoinfoBtn"+lang).replaceWith('<div class="btn btn-info" id="neoinfoBtn2Done">Chargement effectué. ' + neooccGroup.size() + ' néologismes. ' + allv + ' occurrences. Début de période : ' + minDate.toLocaleString() + '</div>');
